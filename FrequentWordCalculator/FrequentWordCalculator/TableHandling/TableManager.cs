    ...
    public class TableManager
    {
        ...
        public TableManager(string TableName)
        {
            ...
            try
            {
                ...
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=ranganayaki;AccountKey=L09i3YauQgYif5jvdLnn7xP2Y9DpLaHmcx8dEMauYlsoOXMVxyAQriSFGynN6uzcwnWqsshIES6m+oASCx0y/Q==;EndpointSuffix=core.windows.net";
